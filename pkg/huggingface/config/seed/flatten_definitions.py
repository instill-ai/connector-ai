...
openapi_schema_template = {
    ...
    "info": {
        "version": "1.0.0",
        "title": "Hugging Face AI Connector Openapi"
    },
    "paths": {
        "/execute": {
            "post": {
...
openapi_schema = {}
for task_name in ["TEXT_GENERATION", "TEXT_TO_IMAGE", "FILL_MASK", "SUMMARIZATION", "TEXT_CLASSIFICATION", "TOKEN_CLASSIFICATION", "TRANSLATION", "ZERO_SHOT_CLASSIFICATION", "FEATURE_EXTRACTION", "QUESTION_ANSWERING", "TABLE_QUESTION_ANSWERING", "SENTENCE_SIMILARITY", "CONVERSATIONAL", "IMAGE_CLASSIFICATION", "IMAGE_SEGMENTATION", "OBJECT_DETECTION", "IMAGE_TO_TEXT", "SPEECH_RECOGNITION", "AUDIO_CLASSIFICATION"]:
