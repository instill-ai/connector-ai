...
NAME = "Instill Model"
TASKS = ['TASK_CLASSIFICATION', 'TASK_INSTANCE_SEGMENTATION', 'TASK_KEYPOINT', 'TASK_DETECTION',
         'TASK_OCR', 'TASK_SEMANTIC_SEGMENTATION', 'TASK_TEXT_GENERATION', 'TASK_TEXT_TO_IMAGE']
