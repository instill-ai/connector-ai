...
func (c *Connection) executeOCR(model *modelPB.Model, inputs []*connectorPB.DataPayload) ([]*connectorPB.DataPayload, error) {
	if len(inputs) <= 0 {
	...
	modelInput := &modelPB.TaskInput_Ocr{
