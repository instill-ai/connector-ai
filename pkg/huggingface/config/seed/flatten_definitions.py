...
openapi_schema = {}
for task_name in ["TEXT_GENERATION", "TEXT_TO_IMAGE", "FILL_MASK", "SUMMARIZATION", "TEXT_CLASSIFICATION", "TOKEN_CLASSIFICATION", "TRANSLATION", "ZERO_SHOT_CLASSIFICATION", "FEATURE_EXTRACTION", "QUESTION_ANSWERING", "TABLE_QUESTION_ANSWERING", "SENTENCE_SIMILARITY", "CONVERSATIONAL"]:
